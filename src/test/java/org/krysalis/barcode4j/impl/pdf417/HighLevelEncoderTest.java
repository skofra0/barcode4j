...
public class HighLevelEncoderTest extends TestCase implements PDF417Constants {
  ...
  public void testCharsets() throws Exception {
    ...
    result = TestHelper.visualize(PDF417HighLevelEncoder.encodeHighLevel(msg, "ISO-8859-1", false));
    expected = "901 141 390 364 700 692 228 228 228 228";
    log(expected, result);
    assertEquals(expected, result);

    // Same text but this time with ISO-8859-1 and ECI enabled
    result = TestHelper.visualize(PDF417HighLevelEncoder.encodeHighLevel(msg, "ISO-8859-1", true));
