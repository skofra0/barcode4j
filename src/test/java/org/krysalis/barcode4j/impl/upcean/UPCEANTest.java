...
public class UPCEANTest extends TestCase {
  ...
  public void testSupplemental2() throws Exception {
    ...
    expected = "<SBG:upc-ean-supp:34>" + "<SBG:upc-ean-guard:null>B1W1B2</SBG>" + "<SBG:msg-char:3>W1B1W4B1</SBG>" + "<SBG:upc-ean-guard:null>W1B1</SBG>" + "<SBG:msg-char:4>W1B1W3B2</SBG>" + "</SBG>";
  ...
  public void testSupplemental5() throws Exception {
    ...
    expected = "<SBG:upc-ean-supp:51234>" + "<SBG:upc-ean-guard:null>B1W1B2</SBG>" + "<SBG:msg-char:5>W1B2W3B1</SBG>" + "<SBG:upc-ean-guard:null>W1B1</SBG>" + "<SBG:msg-char:1>W2B2W2B1</SBG>" + "<SBG:upc-ean-guard:null>W1B1</SBG>" + "<SBG:msg-char:2>W2B2W1B2</SBG>" + "<SBG:upc-ean-guard:null>W1B1</SBG>" + "<SBG:msg-char:3>W1B4W1B1</SBG>" + "<SBG:upc-ean-guard:null>W1B1</SBG>" + "<SBG:msg-char:4>W2B3W1B1</SBG>" + "</SBG>";
    // System.out.println("expected: " + expected);
    // System.out.println("actual: " + sb.toString());
    assertEquals(expected, sb.toString());
  }
