...
public class UPCATest extends TestCase {
  ...
  public void testLogic() throws Exception {
    ...
    expected = "<BC>" + "<SBG:upc-ean-guard:null>B1W1B1</SBG>" + "<SBG:upc-ean-lead:0>" + "<SBG:msg-char:0>W3B2W1B1</SBG>" + "</SBG>" + "<SBG:upc-ean-group:01234>" + "<SBG:msg-char:0>W3B2W1B1</SBG>" + "<SBG:msg-char:1>W2B2W2B1</SBG>" + "<SBG:msg-char:2>W2B1W2B2</SBG>" + "<SBG:msg-char:3>W1B4W1B1</SBG>" + "<SBG:msg-char:4>W1B1W3B2</SBG>" + "</SBG>" + "<SBG:upc-ean-guard:null>W1B1W1B1W1</SBG>" + "<SBG:upc-ean-group:56789>" + "<SBG:msg-char:5>B1W2B3W1</SBG>" + "<SBG:msg-char:6>B1W1B1W4</SBG>"
        + "<SBG:msg-char:7>B1W3B1W2</SBG>" + "<SBG:msg-char:8>B1W2B1W3</SBG>" + "<SBG:msg-char:9>B3W1B1W2</SBG>" + "</SBG>" + "<SBG:upc-ean-check:5>" + "<SBG:msg-char:5>B1W2B3W1</SBG>" + "</SBG>" + "<SBG:upc-ean-guard:null>B1W1B1</SBG>" + "</BC>";
    ...
    logic.generateBarcodeLogic(new MockClassicBarcodeLogicHandler(sb), "001234567895");
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
