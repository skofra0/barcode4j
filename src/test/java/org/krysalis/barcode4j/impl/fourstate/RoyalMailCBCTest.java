...
public class RoyalMailCBCTest extends TestCase {
  ...
  public void testLogic() throws Exception {
    ...
    String expected = "<BC>" + "<SBG:msg-char:(>B1</SBG>" + "<SBG:msg-char:B>B2B3B0B1</SBG>" + "<SBG:msg-char:3>B2B0B1B3</SBG>" + "<SBG:msg-char:1>B0B2B1B3</SBG>" + "<SBG:msg-char:H>B2B3B1B0</SBG>" + "<SBG:msg-char:Q>B1B2B3B0</SBG>" + "<SBG:msg-char:1>B0B2B1B3</SBG>" + "<SBG:msg-char:A>B2B1B2B1</SBG>" + "<SBG:msg-char:F>B2B1B1B2</SBG>" + "<SBG:msg-char:)>B3</SBG>" + "</BC>";
