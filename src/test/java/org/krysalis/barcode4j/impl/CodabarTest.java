...
public class CodabarTest extends TestCase {
  ...
  public void testLogic() throws Exception {
    ...
    expected = "<BC>" + "<SBG:msg-char:d>B1W1B1W2B2W2B1</SBG>" + "W1" + "<SBG:msg-char:1>B1W1B1W1B2W2B1</SBG>" + "W1" + "<SBG:msg-char:2>B1W1B1W2B1W1B2</SBG>" + "W1" + "<SBG:msg-char:3>B2W2B1W1B1W1B1</SBG>" + "W1" + "<SBG:msg-char:e>B1W1B1W2B2W2B1</SBG>" + "</BC>";
  ...
  public void testStartStopHandling() throws Exception {
    ...
    expected = "<BC:*12*>" + "<SBG:msg-char:*>B1W1B1W2B1W2B2</SBG>" + "W1" + "<SBG:msg-char:1>B1W1B1W1B2W2B1</SBG>" + "W1" + "<SBG:msg-char:2>B1W1B1W2B1W1B2</SBG>" + "W1" + "<SBG:msg-char:*>B1W1B1W2B1W2B2</SBG>" + "</BC>";
    assertEquals(expected, sb.toString());
