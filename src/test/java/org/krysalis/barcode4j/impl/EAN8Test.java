...
public class EAN8Test extends TestCase {
  ...
  public void testLogic() throws Exception {
    ...
    expected = "<BC>" + "<SBG:upc-ean-guard:null>B1W1B1</SBG>" + "<SBG:upc-ean-group:2213>" + "<SBG:msg-char:2>W2B1W2B2</SBG>" + "<SBG:msg-char:2>W2B1W2B2</SBG>" + "<SBG:msg-char:1>W2B2W2B1</SBG>" + "<SBG:msg-char:3>W1B4W1B1</SBG>" + "</SBG>" + "<SBG:upc-ean-guard:null>W1B1W1B1W1</SBG>" + "<SBG:upc-ean-group:9337>" + "<SBG:msg-char:9>B3W1B1W2</SBG>" + "<SBG:msg-char:3>B1W4B1W1</SBG>" + "<SBG:msg-char:3>B1W4B1W1</SBG>" + "<SBG:upc-ean-check:7>" + "<SBG:msg-char:7>B1W3B1W2</SBG>" + "</SBG>"
        + "</SBG>" + "<SBG:upc-ean-guard:null>B1W1B1</SBG>" + "</BC>";
