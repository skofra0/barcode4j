...
public class Code128EncoderTest extends TestCase {
  ...
  private static final String[] CHAR_NAMES = {"NUL", "SOH", "STX", "ETX", "EOT", "ENQ", "ACK", "BEL", "BS", "HT", "LF", "VT", "FF", "CR", "SO", "SI", "DLE", "DC1", "DC2", "DC3", "DC4", "NAK", "SYN", "ETB", "CAN", "EM", "SUB", "ESC", "FS", "GS", "RS", "US"}; // ASCII 0-31
  ...
  private void testEncoder(Code128Encoder encoder) throws Exception {
    ...
    assertTrue(res.equals("->BCode->C[56][78]->B9a") || res.equals("->BCode5->C[67][89]->Ba") || res.equals("->BCode5->C[67][89]<SHIFT-B>a"));
  ...
  public void testBug942246() throws Exception {
    ...
    assertTrue("->C[37][10]->B0<FNC1>->C[31][1][0][2][0]".equals(eff) || "->C[37][10]->B0->C<FNC1>[31][1][0][2][0]".equals(eff));
    eff = encodeToDebug("\u00f1020456789012341837100\u00f13101000200", encoder);
    assertTrue("->C<FNC1>[2][4][56][78][90][12][34][18][37][10]->B0<FNC1>->C[31][1][0][2][0]".equals(eff) || "->C<FNC1>[2][4][56][78][90][12][34][18][37][10]->B0->C<FNC1>[31][1][0][2][0]".equals(eff));
    assertEquals("->C<FNC1>[2][4][56][78][90][12][34][18][37][10]<FNC1>[31][1][0][2][0]", encodeToDebug("\u00f102045678901234183710\u00f13101000200", encoder));
  }
  ...
  public void testCodesets() throws Exception {
     ...
     * Testing codeset A + B
     */
    encoder = new DefaultCode128Encoder(Code128Constants.CODESET_A | Code128Constants.CODESET_B);
    ...
    assertEquals("->C[74][83][92][75][84][30][18][37][55]", encodeToDebug("748392758430183755", encoder));
    try {
    ...
    encoder = new DefaultCode128Encoder(Code128Constants.CODESET_A | Code128Constants.CODESET_C);
    assertEquals("->A7->C[48][39][27][58][43][1][83][75]", encodeToDebug("74839275843018375", encoder));
    encoder = new DefaultCode128Encoder(Code128Constants.CODESET_B | Code128Constants.CODESET_C);
    assertEquals("->B7->C[48][39][27][58][43][1][83][75]", encodeToDebug("74839275843018375", encoder));
  }
}
