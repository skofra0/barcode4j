...
public class ITF14Test extends TestCase {
  ...
  public void testChecksum() throws Exception {
    ...
    String expected = "<BC><SBG:start-char:null></SBG>" + "<SBG:msg-char:15></SBG>" + "<SBG:msg-char:40></SBG>" + "<SBG:msg-char:01></SBG>" + "<SBG:msg-char:41></SBG>" + "<SBG:msg-char:28></SBG>" + "<SBG:msg-char:87></SBG>" + "<SBG:msg-char:63></SBG>" + "<SBG:stop-char:null></SBG>" + "</BC>";
