...
public class Interleaved2Of5Test extends TestCase {
  ...
  public void testLogic() throws Exception {
    ...
    expected = "<BC><SBG:start-char:null>B1W1B1W1</SBG>" + "<SBG:msg-char:12>B2W1B1W2B1W1B1W1B2W2</SBG>" + "<SBG:msg-char:34>B2W1B2W1B1W2B1W1B1W2</SBG>" + "<SBG:msg-char:56>B2W1B1W2B2W2B1W1B1W1</SBG>" + "<SBG:msg-char:70>B1W1B1W1B1W2B2W2B2W1</SBG>" + "<SBG:stop-char:null>B2W1B1</SBG>" + "</BC>";
    ...
    logic.generateBarcodeLogic(new MockClassicBarcodeLogicHandler(sb), "12345670");
    expected = "<BC><SBG:start-char:null>B1W1B1W1</SBG>" + "<SBG:msg-char:01>B1W2B1W1B2W1B2W1B1W2</SBG>" + "<SBG:msg-char:23>B1W2B2W2B1W1B1W1B2W1</SBG>" + "<SBG:msg-char:45>B1W2B1W1B2W2B1W1B2W1</SBG>" + "<SBG:msg-char:67>B1W1B2W1B2W1B1W2B1W2</SBG>" + "<SBG:msg-char:00>B1W1B1W1B2W2B2W2B1W1</SBG>" + "<SBG:stop-char:null>B2W1B1</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
