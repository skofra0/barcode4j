...
public class PlacementTest extends TestCase {
  ...
  public void testPlacement() throws Exception {
    String codewords = TestHelper.unvisualize("66 74 78 66 74 78 129 56 35 102 192 96 226 100 156 1 107 221"); // "AIMAIM" encoded
    DebugPlacement placement = new DebugPlacement(codewords.toString(), 12, 12);
    placement.place();
    String[] expected = new String[] {"011100001111", "001010101000", "010001010100", "001010100010", "000111000100", "011000010100", "000100001101", "011000010000", "001100001101", "100010010111", "011101011010", "001011001010"};
  ...
  private class DebugPlacement extends DefaultDataMatrixPlacement {
    ...
    protected void setBit(int col, int row, boolean bit) {
      if (DEBUG) {
        System.out.println("Set bit x=" + col + " y=" + row + " --> " + (bit ? "BLACK" : "white"));
      }
