...
public class Code39Test extends TestCase {
  ...
  public void testIllegalChars() throws Exception {
    ...
    try {
      ...
      String expected = "<BC:1>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "</BC>";
    ...
    try {
      ...
      logic.generateBarcodeLogic(new MockClassicBarcodeLogicHandler(sb, true), "*1*");
      String expected = "<BC:*1*>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:/>B1W2B1W2B1W1B1W2B1</SBG>" + "W-1" + "<SBG:msg-char:J>B1W1B1W1B2W2B2W1B1</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:/>B1W2B1W2B1W1B1W2B1</SBG>" + "W-1" + "<SBG:msg-char:J>B1W1B1W1B2W2B2W1B1</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "</BC>";
      // System.out.println(expected);
      // System.out.println(sb.toString());
      assertEquals(expected, sb.toString());
    } catch (IllegalArgumentException iae) {
  ...
  public void testLogic() throws Exception {
    ...
    expected = "<BC:123ABC>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:2>B1W1B2W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:3>B2W1B2W2B1W1B1W1B1</SBG>" + "W-1" + "<SBG:msg-char:A>B2W1B1W1B1W2B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:B>B1W1B2W1B1W2B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:C>B2W1B2W1B1W2B1W1B1</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>"
        + "</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
    ...
    expected = "<BC>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:2>B1W1B2W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:3>B2W1B2W2B1W1B1W1B1</SBG>" + "W-1" + "<SBG:msg-char:6>B1W1B2W2B2W1B1W1B1</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
  ...
  public void testDisplayStartStop() throws Exception {
    ...
    expected = "<BC:*123*>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:2>B1W1B2W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:3>B2W1B2W2B1W1B1W1B1</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
  }
  ...
  public void testDisplayChecksum() throws Exception {
    ...
    logic.generateBarcodeLogic(new MockClassicBarcodeLogicHandler(sb, true), "123");
    expected = "<BC:1236>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:2>B1W1B2W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:3>B2W1B2W2B1W1B1W1B1</SBG>" + "W-1" + "<SBG:msg-char:6>B1W1B2W2B2W1B1W1B1</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
  }
  ...
  public void testExtendedCharSet() throws Exception {
    ...
    String expected = "<BC>" + "<SBG:start-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>" + "</SBG>" + "W-1" + "<SBG:msg-char:+>B1W2B1W1B1W2B1W2B1</SBG>" + "W-1" + "<SBG:msg-char:A>B2W1B1W1B1W2B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:1>B2W1B1W2B1W1B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:/>B1W2B1W2B1W1B1W2B1</SBG>" + "W-1" + "<SBG:msg-char:D>B1W1B1W1B2W2B1W1B2</SBG>" + "W-1" + "<SBG:msg-char:A>B2W1B1W1B1W2B1W1B2</SBG>" + "W-1" + "<SBG:stop-char:*>" + "<SBG:msg-char:*>B1W2B1W1B2W1B2W1B1</SBG>"
        + "</SBG>" + "</BC>";
    // System.out.println(expected);
    // System.out.println(sb.toString());
    assertEquals(expected, sb.toString());
