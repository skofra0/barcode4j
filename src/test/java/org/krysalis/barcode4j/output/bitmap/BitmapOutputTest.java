...
public class BitmapOutputTest extends TestCase {
  ...
  public void testBitmap() throws Exception {
    ...
    BufferedImage image = BitmapBuilder.prepareImage(dim, 200, BufferedImage.TYPE_INT_RGB);
  ...
  public void testBitmapFile() throws Exception {
    ...
    BitmapCanvasProvider provider = new BitmapCanvasProvider(baout, "image/jpeg", 200, BufferedImage.TYPE_BYTE_GRAY, true, 0);
  ...
  public void testBitmapBuffered() throws Exception {
    ...
    BitmapCanvasProvider provider = new BitmapCanvasProvider(200, BufferedImage.TYPE_BYTE_GRAY, true, 0);
