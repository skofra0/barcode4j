 ...
 */
public abstract class AbstractVariableHeightLogicHandler implements ClassicBarcodeLogicHandler {
  ...
  public void endBarcode() {
    if (bcBean.getMsgPosition() != HumanReadablePlacement.HRP_NONE) {
      ...
      DrawingUtil.drawText(canvas, bcBean, formattedMsg, getStartX(), x, texty, this.textAlignment);
    }
  }
