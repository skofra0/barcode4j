...
public class PDF417 extends ConfigurableBarcodeGenerator implements Configurable {
  ...
  public void configure(Configuration cfg) throws ConfigurationException {
    ...
    getPDF417Bean().setErrorCorrectionLevel(cfg.getChild("ec-level").getValueAsInteger(PDF417Bean.DEFAULT_ERROR_CORRECTION_LEVEL));
    ...
    if (rhs != null) {
      ...
      getPDF417Bean().setRowHeight(PDF417Bean.DEFAULT_X_TO_Y_FACTOR * getBean().getModuleWidth());
    }
