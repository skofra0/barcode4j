...
public abstract class UPCEANLogicImpl {
  ...
  private static final byte[][] CHARSET = {{3, 2, 1, 1}, {2, 2, 2, 1}, {2, 1, 2, 2}, {1, 4, 1, 1}, {1, 1, 3, 2}, {1, 2, 3, 1}, {1, 1, 1, 4}, {1, 3, 1, 2}, {1, 2, 1, 3}, {3, 1, 1, 2}};

  private static final byte O = ODD_PARITY;
  private static final byte E = EVEN_PARITY;

  private static final byte[][] SUPP2_PARITY = {{O, O}, {O, E}, {E, O}, {E, E}};

  private static final byte[][] SUPP5_PARITY = {{E, E, O, O, O}, {E, O, E, O, O}, {E, O, O, E, O}, {E, O, O, O, E}, {O, E, E, O, O}, {O, O, E, E, O}, {O, O, O, E, E}, {O, E, O, E, O}, {O, E, O, O, E}, {O, O, E, O, E}};
  ...
  protected void encodeChar(ClassicBarcodeLogicHandler logic, char c, int charset) {
    ...
    if (charset == LEFT_HAND_B) {
      ...
      for (byte i = 0; i < 4; i++) {
        ...
        final boolean black = ((i % 2 == 0 && charset == RIGHT_HAND) || (i % 2 != 0 && charset == LEFT_HAND_A));
        logic.addBar(black, width);
      }
    }
    logic.endBarGroup();
