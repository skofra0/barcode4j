...
public class POSTNETBean extends HeightVariableBarcodeBean {
  ...
  public void generateBarcode(CanvasProvider canvas, String msg) {
    ...
    POSTNETLogicImpl impl = new POSTNETLogicImpl(getChecksumMode(), isDisplayChecksum());
  ...
  public BarcodeDimension calcDimensions(String msg) {
    ...
    final double width = (((modMsg.length() * 5) + 2) * moduleWidth) + (((modMsg.length() * 5) + 1) * intercharGapWidth);
    ...
    return new BarcodeDimension(width, height, width + (2 * qz), height + (2 * qzv), quietZone, qzv);
  }
