...
public class Interleaved2Of5 extends ConfigurableBarcodeGenerator implements Configurable {
  ...
  public void configure(Configuration cfg) throws ConfigurationException {
    ...
    Length mw = new Length(cfg.getChild("module-width").getValue(bean.getModuleWidth() + "mm"), "mm");
    bean.setModuleWidth(mw.getValueAsMillimeter());

    super.configure(cfg);

    // Checksum mode
    bean.setChecksumMode(ChecksumMode.byName(cfg.getChild("checksum").getValue(ChecksumMode.CP_AUTO.getName())));
